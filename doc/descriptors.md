# Support for Output Descriptors in Hardcoin Core

Since Hardcoin Core v0.17, there is support for Output Descriptors in the
...
on Hardcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Hardcoin Core wallets, a convenience function `combo` is
