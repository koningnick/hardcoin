...
* hardcoin.conf: contains configuration settings for hardcoind or hardcoin-qt
* hardcoind.pid: stores the process id of hardcoind while running
...
* debug.log: contains debug information and general logging generated by hardcoind or hardcoin-qt
