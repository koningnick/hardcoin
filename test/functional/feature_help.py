...
"""Verify that starting hardcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hardcoin with -h for help text")
        ...
        self.log.info("Start hardcoin with -version for version information")
        ...
        self.log.info("Start hardcoind with -fakearg to make sure it does not start")
