...
const char * const BITCOIN_CONF_FILENAME = "hardcoin.conf";
const char * const BITCOIN_PID_FILENAME = "hardcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Hardcoin";
#else
    // Unix
