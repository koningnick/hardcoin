...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " hardcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  hardcoin-tx [options] <hex-tx> [commands]  Update hex-encoded hardcoin transaction\n" +
            "or:     hardcoin-tx [options] -create [commands]   Create hex-encoded hardcoin transaction\n" +
            "\n";
