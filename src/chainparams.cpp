...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TESTDUMMY].nTimeout = 1571338669; 

        // Deployment of BIP68, BIP112, and BIP113.
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].bit = 0;
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 0; 
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1571338669; 

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 0; 
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout = 1571338669; 
        ...
        //vSeeds.emplace_back("seed-a.hardcoin.loshan.co.uk");
        //vSeeds.emplace_back("dnsseed.thrasher.io");
        //vSeeds.emplace_back("dnsseed.hardcointools.com");
        //vSeeds.emplace_back("dnsseed.hardcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        //vSeeds.emplace_back("testnet-seed.hardcointools.com");
        //vSeeds.emplace_back("seed-b.hardcoin.loshan.co.uk");
